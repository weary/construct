...
if __name__ == "__main__":
    ...
    serveroper.wait_for_line(
        ":construct!-@- NOTICE %s :already identified" % serveroper.nick)
    ...
    allowed.wait_for_line(
        ":construct!-@- NOTICE aLlowed :User aLlowed already registered")
    ...
    serveroper.cmd(
        "confirm %s Channel -Confirmed- Operator chanoper@someemail" % chanoper.nick)
    chanoper.cmd("whoami")
    chanoper.cmd("whoami", specify_server=True)
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :You are cHanoper, confirmed, no defined roles")
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :Real name: Channel -Confirmed- Operator")
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :Email: chanoper@someemail")
    chanoper.cmd("whois chanoper")
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :chanoper is online and confirmed as cHanoper, no defined roles")
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :Real name: Channel -Confirmed- Operator")
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :Email: chanoper@someemail")
    ...
    serveroper.wait_for_line(
        ":construct!-@- NOTICE sErveroper :finished starting")
    ...
    chanoper.wait_for_line(
        ":construct!-@- NOTICE %s :Trying to register a channel" % chanoper.nick)
    ...
    allowed.wait_for_line(
        ":cHanoper!chanoper2@127.0.0.1 MODE #testchan +o aLlowed")
    chanoper.cmd("channel roles #testchan", True)
    chanoper.wait_for_line(":construct!-@- NOTICE cHanoper :- aLlowed oper")
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :total 2 role(s) defined for #testchan")
    ...
    serveroper.wait_for_line(
        ":construct!-@- NOTICE sErveroper :chanoper is online and confirmed as cHanoper, allowed in #testchan")
    serveroper.cmd("whois allowed")
    serveroper.wait_for_line(
        ":construct!-@- NOTICE sErveroper :allowed is online and registered as aLlowed, oper in #testchan")
    serveroper.cmd("whois banned")
    serveroper.wait_for_line(
        ":construct!-@- NOTICE sErveroper :banned is online and registered as bAnned, banned in #testchan")
    ...
    chanoper.cmd("channel roles #testchan", True)
    chanoper.wait_for_line(
        ":construct!-@- NOTICE cHanoper :'cHanoper' is not a channel operator on '#testchan'")
